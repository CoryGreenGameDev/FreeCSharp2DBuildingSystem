 	...
 	void Start() {
  	...
  	void Update() {
  		...
  		if(isEnemy || isCitizen){
    	    ...
    	    if(randomInt == 1 && tr.position == pos && !Physics2D.OverlapPoint(pos + Vector3.down)){pos += Vector3.down;}
    		if(randomInt == 2 && tr.position == pos && !Physics2D.OverlapPoint(pos + Vector3.up)){pos += Vector3.up;}
    		if(randomInt == 3 && tr.position == pos && !Physics2D.OverlapPoint(pos + Vector3.left)){pos += Vector3.left;}
    		if(randomInt == 4 && tr.position == pos && !Physics2D.OverlapPoint(pos + Vector3.right)){pos += Vector3.right;}
